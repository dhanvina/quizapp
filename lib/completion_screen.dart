...
class SuccessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isWeb = screenSize.width > 800; // Adjust width for web
    ...
    return Scaffold(
      body: Container(
        ...
        child: Center(
          child: SingleChildScrollView( // Prevent overflow by making the whole screen scrollable
            child: LayoutBuilder(
              builder: (context, constraints) {
                // 50% width for web, 70% for mobile/tablet
                final containerWidth = isWeb ? screenSize.width * 0.5 : screenSize.width * 0.7;

                // Height depends on screen height, with some padding to avoid overflow
                final containerHeight = screenSize.height * 0.6; // Adjust height for smaller screens

                return Container(
                  width: containerWidth, // 50% for web, 70% for others
                  decoration: BoxDecoration(
                  ...
                  child: Padding( // Add padding to avoid overflow
